  ...
  <div class="min-h-screen flex flex-col bg-[#F9F9F9] text-[#1a1a1a]">
    ...
    <main class="flex-1 pb-2 sm:pb-3">
      ...
      <div class="max-w-[1400px] mx-auto px-3 sm:px-4 md:px-6 lg:px-8 space-y-6 md:space-y-8 pt-2 md:pt-6">
        ...
        <!-- 1. Ads Section: Cinematic Hero Banner (Variant 1) -->
        ...
        <!-- 2. Live-First Priority: Full Width BekasKu Live & Video Showcase (Variant 1) -->
        <section id="live-showcase" class="w-full scroll-mt-24" data-aos="fade-up">
          <Var1LiveShopping
        ...
        <!-- 3. Kategori BekasKu: 2 Rows Grid -->
        ...
        <!-- 4. Combined Row: Best Deal Flash Sale (Left) + BekasKu+ Creator Influencer (Right) -->
        ...
        <section id="rekomendasi" class="w-full pt-1" data-aos="fade-up">
          <HomeProductGrid
            ...
            :loading="recLoading"
            :has-more="hasMore"
            :title="searchQuery ? `Hasil Pencarian: &quot;${searchQuery}&quot;` : 'REKOMENDASI BEKASKU PILIHAN'"
            @load-more="loadMore"
          />
        </section>
    ...
    <!-- Footer Variant 1 (Dark Surface Trust Bar & Rekber Protection) -->
    <Var1Footer class="hidden md:block" />
...
import Var1Banner from '~/components/variants/var1/Var1Banner.vue'
import Var1LiveShopping from '~/components/variants/var1/Var1LiveShopping.vue'
import Var1Footer from '~/components/variants/var1/Var1Footer.vue'

const route = useRoute()
const searchQuery = computed(() => (route.query.q as string) || '')

useHead({
  title: 'Bekasku (Varian 1) — Live Shopping & Reels Preloved #1 Indonesia',
  meta: [
    { name: 'description', content: 'Varian 1 BekasKu: Pengalaman belanja live streaming interaktif dan reels barang bekas original bergaransi rekber.' },
  ],
})
